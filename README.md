...
| LoRa pair (remote + gateway) | Bluetooth keyboard mode | WiFi setup → web panel |
|---|---|---|
| ![LoRa scenario](img/scenario-lora.svg) | ![BLE scenario](img/scenario-ble.svg) | ![WiFi setup scenario](img/scenario-setup.svg) |
