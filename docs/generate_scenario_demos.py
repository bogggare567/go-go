...
@keyframes k-wave-ack2 { 0%,63% {opacity:0; transform:scale(.4)} 65% {opacity:.9} 71% {opacity:0; transform:scale(1.7)} 72%,100% {opacity:0; transform:scale(.4)} }
.wave-go    { animation: k-wave-go    12s ease-out infinite; transform-origin: 470px 480px; transform-box: view-box; }
.wave-panic { animation: k-wave-panic 12s ease-out infinite; transform-origin: 470px 480px; transform-box: view-box; }
.wave-ack   { animation: k-wave-ack   12s ease-out infinite; transform-origin: 700px 480px; transform-box: view-box; }
.wave-ack2  { animation: k-wave-ack2  12s ease-out infinite; transform-origin: 700px 480px; transform-box: view-box; }
'''
...
<!-- outbound GO/PANIC waves TX -> RX, ACK waves back -->
<g stroke="#6fd18c" stroke-width="5" fill="none">
  <path class="wave-go" d="M470 460 a70 70 0 0 1 0 110"/>
  <path class="wave-panic" d="M470 460 a70 70 0 0 1 0 110"/>
</g>
<g stroke="#7fb4ff" stroke-width="4" fill="none">
  <path class="wave-ack" d="M700 460 a55 55 0 0 0 0 110"/>
  <path class="wave-ack2" d="M700 460 a55 55 0 0 0 0 110"/>
</g>
